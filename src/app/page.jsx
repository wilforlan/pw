...
import image5 from '@/images/photos/pw-3.jpg'
...
function Resume() {
  let resume = [
    ...
    {
      company: 'Technical Tutor',
      title: 'PG Institute of Technology',
      logo: logoStarbucks,
      start: '2013',
      end: '2017',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="mailto:williams@fuddle.ai" variant="secondary" className="group mt-6 w-full">
        Reach Me
